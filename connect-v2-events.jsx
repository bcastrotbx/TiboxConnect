// Tibox Connect v2 — News + Events + Opinion
...
function InscripcionModal({ event, onClose }) {
  ...
  return (
    <Shell onClose={onClose} maxWidth={460}>
      {done ? (
        ...
        <React.Fragment>
              ...
              {[
                ...
                <div key={i} style={{display:'flex',alignItems:'center',gap:11,padding:'11px 13px',background:'var(--gray-50)',borderRadius:11,border:'1px solid var(--gray-200)'}}>
                  <div style={{width:34,height:34,borderRadius:9,flexShrink:0,display:'flex',alignItems:'center',justifyContent:'center',background:(it.color||'#0050C8')+'15'}}>
                    <i data-lucide={it.ic} style={{width:16,height:16,color:it.color||'#0050C8'}}></i>
                  </div>
          ...
          <div style={{padding:'16px 24px 4px'}}>
            <div style={{fontSize:11,fontWeight:700,letterSpacing:'0.08em',textTransform:'uppercase',color:'var(--brand-cyan-700,#0079a8)',marginBottom:8,display:'flex',alignItems:'center',gap:6}}>
              <i data-lucide="info" style={{width:13,height:13}}></i>Sobre el evento
            </div>
          ...
          <div style={{padding:'18px 24px 6px'}}>
            <div style={{fontSize:11,fontWeight:700,letterSpacing:'0.08em',textTransform:'uppercase',color:'#FF6707',display:'flex',alignItems:'center',gap:6}}>
              <i data-lucide="user-plus" style={{width:13,height:13}}></i>Completa tu inscripción
            </div>
          </div>
          <form onSubmit={submit} style={{padding:'10px 24px 24px',display:'flex',flexDirection:'column',gap:13}}>
            ...
            >
              <i data-lucide="check-circle-2" style={{width:16,height:16}}></i>Confirmar inscripción
            </button>
          </form>
        </React.Fragment>
      )}
...
const PARTNERS = {
  microsoft: { logo:window.__res('partnerMicrosoft','assets/partner-microsoft.svg'), name:'Microsoft' },
  azure:     { logo:window.__res('partnerAzure','assets/partner-azure.svg'),     name:'Microsoft Azure' },
  veeam:     { logo:window.__res('partnerVeeam','assets/partner-veeam.svg'),     name:'Veeam' },
  hpe:       { logo:window.__res('partnerHpe','assets/partner-hpe.svg'),       name:'HPE' },
};

const eventItems = [
  {id:1, day:'19', month:'Jun', title:'Webinar: Ciberseguridad para PYMES Chile 2026', modalidad:'Online', time:'10:00 – 11:30', place:'Microsoft Teams', partner:'microsoft', img:window.__res('videoCiber','assets/video-ciber.jpg'),
  ...
  {id:2, day:'24', month:'Jun', title:'Taller: Implementación SD-WAN en tu empresa', modalidad:'Presencial', time:'09:30 – 13:00', place:'Oficina TIBOX, Vitacura', city:'Santiago', partner:'hpe', img:window.__res('heroSlide1','assets/hero-slider-1.jpg'),
  ...
  {id:3, day:'02', month:'Jul', title:'Demo en vivo: TIBOX NOC, monitoreo 24/7', modalidad:'Online', time:'16:00 – 17:00', place:'Zoom', partner:'azure', img:window.__res('videoCloud','assets/video-cloud.jpg'),
  ...
  {id:4, day:'10', month:'Jul', title:'Conferencia: Transformación Digital en Retail', modalidad:'Híbrida', time:'08:30 – 13:30', place:'Hotel W, Santiago', city:'Santiago', partner:'microsoft', img:window.__res('videoEvento','assets/video-evento.jpg'),
  ...
  {id:5, day:'16', month:'Jul', title:'Webinar: FinOps — optimiza tus costos cloud', modalidad:'Online', time:'11:00 – 12:00', place:'Microsoft Teams', partner:'azure', img:window.__res('videoM365','assets/video-m365.jpg'),
  ...
  {id:6, day:'23', month:'Jul', title:'Taller: Respaldo y recuperación con Veeam', modalidad:'Presencial', time:'09:00 – 12:30', place:'Oficina TIBOX, Curicó', city:'Curicó', partner:'veeam', img:window.__res('info2','assets/info-2.jpg'),
  ...
  {id:7, day:'30', month:'Jul', title:'Demo: Chatbots con IA para tu empresa', modalidad:'Online', time:'15:00 – 16:00', place:'Zoom', partner:'azure', img:window.__res('videoIa','assets/video-ia.jpg'),
  ...
  {id:8, day:'06', month:'Ago', title:'Mesa redonda: Zero Trust en la práctica', modalidad:'Híbrida', time:'09:00 – 11:30', place:'Oficina TIBOX, Miraflores', city:'Lima', partner:'microsoft', img:window.__res('videoCopilot','assets/video-copilot.jpg'),
...
const pastEventItems = [
  {id:101, day:'28', month:'May', title:'Cumbre TIBOX Cloud & IA 2026', modalidad:'Presencial', time:'09:00 – 14:00', place:'Hotel W, Santiago', attendees:'180 asistentes', partner:'microsoft',
    img:window.__res('heroUniverse','assets/hero-universe.jpg'),
    ...
    gallery:[window.__res('info1','assets/info-1.jpg'),window.__res('videoEvento','assets/video-evento.jpg'),window.__res('videoCloud','assets/video-cloud.jpg'),window.__res('heroSlide2','assets/hero-slider-2.jpg')]},
  {id:102, day:'15', month:'May', title:'Workshop: Ciberseguridad Empresarial', modalidad:'Presencial', time:'09:30 – 13:00', place:'Oficina TIBOX, Vitacura', attendees:'45 asistentes', partner:'microsoft',
    img:window.__res('videoCiber','assets/video-ciber.jpg'),
    ...
    gallery:[window.__res('videoCopilot','assets/video-copilot.jpg'),window.__res('info3','assets/info-3.jpg'),window.__res('videoM365','assets/video-m365.jpg'),window.__res('info4','assets/info-4.jpg')]},
  {id:103, day:'30', month:'Abr', title:'TIBOX Connect Day Santiago', modalidad:'Híbrida', time:'08:30 – 13:30', place:'Espacio Riesco, Santiago', attendees:'320 asistentes', partner:'azure',
    img:window.__res('videoEvento','assets/video-evento.jpg'),
    ...
    gallery:[window.__res('heroSlide1','assets/hero-slider-1.jpg'),window.__res('heroSlide3','assets/hero-slider-3.jpg'),window.__res('info2','assets/info-2.jpg'),window.__res('videoWebinar','assets/video-webinar.jpg')]},
  {id:104, day:'18', month:'Abr', title:'Webinar: Continuidad Operacional 24/7', modalidad:'Online', time:'11:00 – 12:00', place:'Microsoft Teams', attendees:'210 asistentes', partner:'veeam',
    img:window.__res('videoWebinar','assets/video-webinar.jpg'),
    ...
    gallery:[window.__res('videoCloud','assets/video-cloud.jpg'),window.__res('info1','assets/info-1.jpg'),window.__res('videoIa','assets/video-ia.jpg'),window.__res('heroUniverse','assets/hero-universe.jpg')]},
];
              ...
              <div style={{flex:1,minWidth:0}}>
                ...
                <div style={{display:'flex',gap:12,marginTop:4,flexWrap:'wrap'}}>
                  <span style={{fontSize:11,color:'var(--gray-500)',display:'inline-flex',alignItems:'center',gap:4}}>
                    <i data-lucide="map-pin" style={{width:11,height:11}}></i>{ev.place}
                  </span>
                  <span style={{fontSize:11,color:'var(--gray-500)',display:'inline-flex',alignItems:'center',gap:4}}>
                    <i data-lucide="clock" style={{width:11,height:11}}></i>{ev.time} hrs
                  </span>
                </div>
              </div>
        ...
        <div style={{flex:1,minWidth:0}}>
          <div style={{display:'flex',alignItems:'center',gap:7,marginBottom:5,flexWrap:'wrap'}}>
            <span style={{fontSize:10,fontWeight:700,borderRadius:999,padding:'2px 9px',background:`${m.color}15`,color:m.color,display:'inline-flex',alignItems:'center',gap:4}}>
              <i data-lucide={m.icon} style={{width:11,height:11}}></i>{ev.modalidad}
            </span>
...
function EventosPanel() {
  ...
  return (
    <div style={{display:'flex',flexDirection:'column',height:'100%',borderRadius:16,overflow:'hidden',position:'relative',background:'var(--grad-corporate)',boxShadow:'0 4px 18px rgba(2,18,55,0.2)'}}>
      {window.CosmicBg2 && React.createElement(window.CosmicBg2, {variant:1})}
      ...
      <div style={{padding:'18px 20px 14px',borderBottom:'1px solid rgba(255,255,255,0.1)',display:'flex',alignItems:'center',justifyContent:'space-between',gap:10,position:'relative'}}>
        ...
        >
          <i data-lucide="calendar-days" style={{width:14,height:14}}></i>Ver calendario
        </button>
      </div>
    ...
    <Shell onClose={onClose} maxWidth={560}>
      ...
      <div style={{position:'relative',height:190,overflow:'hidden',background:'#0b1a3a'}}>
        ...
        <span style={{position:'absolute',top:14,left:14,fontSize:10,fontWeight:700,letterSpacing:'0.06em',textTransform:'uppercase',color:'white',background:'rgba(13,138,78,0.92)',borderRadius:999,padding:'4px 11px',display:'inline-flex',alignItems:'center',gap:5}}>
          <i data-lucide="check-circle-2" style={{width:12,height:12}}></i>Evento realizado
        </span>
        <div style={{position:'absolute',left:0,right:0,bottom:0,padding:'16px 24px'}}>
          ...
          {[
            ...
            <div key={i} style={{padding:'11px 13px',background:'var(--gray-50)',borderRadius:11,border:'1px solid var(--gray-200)'}}>
              <div style={{display:'flex',alignItems:'center',gap:6,marginBottom:5}}>
                <i data-lucide={it.ic} style={{width:13,height:13,color:'#0050C8'}}></i>
      ...
      <div style={{padding:'16px 24px 4px'}}>
        <div style={{fontSize:11,fontWeight:700,letterSpacing:'0.08em',textTransform:'uppercase',color:'#0079a8',marginBottom:8,display:'flex',alignItems:'center',gap:6}}>
          <i data-lucide="file-text" style={{width:13,height:13}}></i>Resumen
        </div>
      ...
      <div style={{padding:'18px 24px 24px'}}>
        <div style={{fontSize:11,fontWeight:700,letterSpacing:'0.08em',textTransform:'uppercase',color:'#FF6707',marginBottom:10,display:'flex',alignItems:'center',gap:6}}>
          <i data-lucide="images" style={{width:13,height:13}}></i>Galería del evento
        </div>
    ...
    >
        ...
        <div style={{flex:1,minWidth:0}}>
          <div style={{display:'flex',alignItems:'center',gap:7,marginBottom:5,flexWrap:'wrap'}}>
            <span style={{fontSize:10,fontWeight:700,borderRadius:999,padding:'2px 9px',background:'rgba(13,138,78,0.12)',color:'#0d8a4e',display:'inline-flex',alignItems:'center',gap:4}}>
              <i data-lucide="check-circle-2" style={{width:11,height:11}}></i>Realizado
            </span>
            <span style={{fontSize:10.5,color:'var(--gray-400)',display:'inline-flex',alignItems:'center',gap:4}}>
              <i data-lucide="calendar" style={{width:11,height:11}}></i>{ev.day} {ev.month}
            </span>
          </div>
          <div style={{fontSize:13.5,fontWeight:700,color:'var(--navy-900)',lineHeight:1.3}}>{ev.title}</div>
        </div>
      ...
      <div style={{display:'flex',alignItems:'center',justifyContent:'space-between',gap:10,paddingTop:2}}>
        <span style={{fontSize:10.5,color:'var(--gray-400)',display:'inline-flex',alignItems:'center',gap:5}}>
          <i data-lucide="users" style={{width:12,height:12}}></i>{ev.attendees}
        </span>
        ...
        >Ver más <i data-lucide="arrow-right" style={{width:13,height:13}}></i></button>
      </div>
    </div>
  );
}

function EventosRealizadosPanel() {
  const [openEvent, setOpenEvent] = React.useState(null);
  const [page, setPage] = React.useState(0);
  React.useEffect(() => { if (window.lucide) window.lucide.createIcons(); });
...
const featuredNews = {
  cat:'ciberseguridad',
  img:window.__res('newsFeatured','assets/news-featured.jpg'),
  date:'11 Jun 2026',
      ...
      <div style={{display:'grid',gridTemplateColumns:'1fr 1fr',gap:0,marginTop:16,borderTop:'1px solid var(--gray-100)'}}>
                ...
                >
                  ...
                  <div style={{flex:1,minWidth:0}}>
                    ...
                    <div style={{fontSize:10.5,color:'var(--gray-400)',marginTop:5,display:'flex',alignItems:'center',gap:4}}>
                      <i data-lucide="clock" style={{width:11,height:11}}></i>{n.date}
                    </div>
                  </div>
                </a>
              );
        ...
        <div style={{padding:'18px 22px',display:'flex',flexDirection:'column'}}>
          <div style={{fontSize:10,fontWeight:700,letterSpacing:'0.12em',textTransform:'uppercase',color:'#FF6707',marginBottom:12,display:'flex',alignItems:'center',gap:6}}>
            <i data-lucide="star" style={{width:13,height:13}}></i>Publicación destacada
          </div>
          ...
          <div style={{display:'flex',alignItems:'center',gap:12,fontSize:11,color:'var(--gray-400)',marginBottom:9}}>
            <span style={{display:'inline-flex',alignItems:'center',gap:4}}><i data-lucide="calendar" style={{width:12,height:12}}></i>{featuredNews.date}</span>
            <span style={{display:'inline-flex',alignItems:'center',gap:4}}><i data-lucide="book-open" style={{width:12,height:12}}></i>{featuredNews.readtime}</span>
          </div>
          ...
          <a href={featuredNews.url} target="_blank" rel="noopener noreferrer" style={{
            ...
            onMouseLeave={e=>e.currentTarget.style.transform='none'}
          >
            Ver publicación <i data-lucide="external-link" style={{width:15,height:15}}></i>
          </a>
        </div>
      </div>
    </div>
...
Object.assign(window, { EventosPanel, EventosRealizadosPanel, NoticiasPanel, InscripcionModal, CalendarModal, VistaModal });
