...
**Commit local únicamente al momento de escribir esto, sin `git push`** — a la espera de que Braulio ejecute la migración `20260810100000_events_gallery.sql`, revise en local con `npm run dev`, y apruebe.
